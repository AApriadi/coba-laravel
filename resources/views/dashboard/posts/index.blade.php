                ...
                @foreach($posts as $post)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="/dashboard/posts/{{ $post->slug }}/edit" class="badge bg-warning mt-1 mb-1"><span data-feather="edit"></span></a>
                            <form action="/dashboard/posts/{{ $post->slug }}" method="post" class="d-inline">
                                @method('delete')
                                @csrf
                                <button class="badge bg-danger mt-1 mb-1 border-0" onclick="return confirm('Are you sure?')"><span data-feather="x-circle"></span></button>
                            </form>
                        </td>
                    </tr>
                @endforeach
